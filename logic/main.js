...
$(function () {
  ...
  $("#dlgSet .diagHead h4").html($("#dlgSet .diagHead h4").html() + `<a href="http://scryfall.com/search?q=${encodeURIComponent("legal:commander and (set:" + setList[banListVer].join(" or set:") + ")")}">X</a>`);
});
